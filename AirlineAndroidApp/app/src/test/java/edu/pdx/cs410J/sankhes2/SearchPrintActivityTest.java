...
public class SearchPrintActivityTest
{

    @Test
    public void SearchPrintDataNotFoundTest()
    {
        SearchPrintActivity searchPrintActivity = Robolectric.setupActivity(SearchPrintActivity.class);
        searchPrintActivity.airline = "Emirates";
        searchPrintActivity.source = "SEA";
        searchPrintActivity.destination = "SFO";
        assertEquals("Data for given airline not found", ShadowToast.getTextOfLatestToast());

    }

    @Test
    public void SearchPrintTest()
    {
        ...
        Intent intent = new Intent(activity,SearchPrintActivity.class);
        intent.putExtra("SearchName","Emirates");
        intent.putExtra("SearchSrc","SEA");
        intent.putExtra("SearchDest","SFO");
        SearchPrintActivity searchPrintActivity = Robolectric.buildActivity(SearchPrintActivity.class, intent).setup().get();
